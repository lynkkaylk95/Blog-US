...
export default function PrivacyPage() {
  return <InfoPage eyebrow="Last updated August 7, 2026" title="Privacy policy" intro="This policy explains what information Porchlight Stories may collect and how it is used.">
    ...
    <h2>Information collected automatically</h2><p>Our hosting and security providers may process basic technical information such as IP address, browser type, requested pages, and security events to deliver and protect the site.</p>
