...
export default function CookiesPage() {
  return <InfoPage eyebrow="Last updated August 7, 2026" title="Cookie policy" intro="Porchlight Stories currently aims to keep browser storage limited and understandable.">
    ...
    <h2>Your controls</h2><p>You can decline optional analytics or change your choice at any time. You can also remove or block browser storage through your browser settings.</p><CookieSettingsButton />
  </InfoPage>;
}
