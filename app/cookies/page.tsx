...
export default function CookiesPage() {
  return <InfoPage eyebrow="Last updated September 21, 2026" title="Cookie policy" intro="Porchlight Stories currently aims to keep browser storage limited and understandable.">
    ...
    <h2>Analytics</h2><p>Cloudflare Web Analytics may measure aggregate traffic and page performance without collecting or using personal data. Google Analytics measures visits and site usage. The site does not load advertising networks or advertising scripts.</p>
