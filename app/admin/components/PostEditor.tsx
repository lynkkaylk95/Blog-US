  ...
  return <main className="admin-main">
    ...
    <form className="admin-editor-form" onSubmit={submit}>
      <section className="admin-panel admin-fields">
        ...
        {isSeries && <div className="field"><label>{t("partNumber")}</label><input type="number" min="1" step="1" value={post.partNumber || 1} onChange={(event) => partNumberChanged(Math.max(1, Number.parseInt(event.target.value, 10) || 1))} /></div>}
